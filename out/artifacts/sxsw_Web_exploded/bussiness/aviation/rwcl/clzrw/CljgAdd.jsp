...
<%
	...
	String rwbhtwo = request.getParameter("rwbhtwo");
...
<script type="text/javascript" src="<%=basePath%>bussiness/aviation/rwcl/clzrw/cljgadd.js"></script>
...
<body>
	...
	<div style="padding:30px; margin-left:92px">
		...
		<tr>
			<td style="vertical-align:top"; ><span style="color:#C2C2C2;">结果描述&nbsp;&nbsp;</span>
			</td>
	...
	<input id="rwbhtwo" type="hidden" value="<%=rwbhtwo %>"/>
	<input id="pre" type="hidden" value="<%=pre %>"/>
