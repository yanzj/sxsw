...
<script src="<%=basePath%>include/LigerUI/js/plugins/ligerDrag.js" type="text/javascript"></script>
    ...
    $(function ()
    {
        ...
        $("#iframe").attr("src","<%=basePath%>flightQueryAllList.action?page=1&pagesize=10");
    });
...
<body > 
       	...
       	<div  id="untitle" title="安检信息列表">
       	 	<!-- <iframe frameborder="0"  src="<%=basePath%>bussiness/aviation/xxcx/hbxx/FlightInfoList.jsp?gmsfzhm=<%=gmsfzhm %>"></iframe> -->
