...
<head>
   ...
   $("#searchBtn").click(function(){
    ...
    var	url="CompanyTaxMessageList.action?type=0&SOCIAL_SECURITY_NO="+SOCIAL_SECURITY_NO+"&COMPANY_NAME="+COMPANY_NAME;
		 $.ajax({
		url:url, 
		async:false,
		dataType:"json", 
		...
		// 重新加载表格数据
		 $("#maingridno").ligerGrid('reload',data);
		}
		});
	});
// 点击清空  
