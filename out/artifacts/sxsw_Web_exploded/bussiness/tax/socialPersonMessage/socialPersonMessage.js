...
jQuery(function($){
	...
	$("#importExcel").click(function(){
		var url = "bussiness/tax/socialPersonMessage/ExcelUpload.jsp";
		window.top.$.ligerDialog.open({
			name:"importExcel",url: url, width:350, height:300, 
			modal: true, isResize: false ,title:"导入社保明细",allowClose:true,
...
function my_initGrid(){
	window['g']=$("#maingrid").ligerGrid({
		...
		rowHeight:24,
   		height: '100%',
   		heightDiff:-8,
		url:"socialPersonMessageQueryList.action",	   																								
		columns: [
        { display: '行政区', name: 'AREA_NAME',minWidth:30 ,width:"10%"},
        { display: '险种', name: 'SOCIAL_NAME', width:"10%",isSort:true},
        
        { display: '人社单位编号', name: 'SOCIAL_SECURITY_NO',minWidth:30 ,width:"10%"},
        { display: '税务纳税人识别号', name: 'TAX_NO', width:"15%",minWidth:30 ,isSort:true},	
        { display: '人社单位名称', name: 'COMPANY_NAME', width:"20%",isSort:true},
        { display: '税务纳税人名称', name: 'PAY_TAX_PEPOLE_NAME', width:"20%",isSort:true},
        { display: '人社参保单位状态', name: 'COMPANY_STATUS', width:"12%",isSort:true},
        { display: '主管税务局', name: 'TAX_BUREAU', width:"20%",isSort:true},
        { display: '人社经办机构', name: 'SOCIAL_SECURITY_ORGANIZATION', width:"15%",isSort:true},
        { display: '登记序号', name: 'REGISTER_NO', width:"15%",isSort:true},
        { display: '人社社保登记姓名', name: 'TAX_PERSON_NAME', width:"12%",isSort:true},
		{ display: '人社医保登记身份证号', name: 'TAX_PERSON_ID', width:"15%",isSort:true},
		{ display: '税务登记姓名', name: 'TAX_REGISRER_NAME', width:"10%",isSort:true},
		{ display: '税务登记身份证号', name: 'TAX_REGISRER_ID', width:"15%",isSort:true},
		{ display: '税务登记来源', name: 'TAX_REGISRER_FROM', width:"10%",isSort:true}
		
		
		/*{ display: '税务登记类型', name: 'TAX_REGISTER_TYPE', width:"15%",isSort:true},
		{ display: '主管税务所科分局', name: 'SUB_TAX_BUREAU', width:"15%",isSort:true},
		{ display: '税务街道乡镇', name: 'TAX_STREET', width:"20%",isSort:true},
		{ display: '人社单位电话', name: 'COMPANY_TEL', width:"15%",isSort:true},
		{ display: '人社单位地址', name: 'COMPANY_ADDRESS', width:"20%",isSort:true},
		{ display: '税务联系方式', name: 'TAX_TEL', width:"10%",isSort:true},
		{ display: '税务生产经营地址', name: 'TAX_PRODUCT_ADDRESS', width:"20%",isSort:true},
		{ display: '人社法人联系方式', name: 'LEGAL_PERSON_TEL', width:"10%",isSort:true},
		{ display: '人社专管员姓名', name: 'SOCIAL_MASTER_NAME', width:"10%",isSort:true},
		{ display: '人社专管员联系方式', name: 'SOCIAL_MASTER_TEL', width:"10%",isSort:true},
		{ display: '人社单位类型', name: 'COMPANY_TYPE', width:"15%",isSort:true},
		{ display: '税收管理员', name: 'TAX_ADMIN', width:"10%",isSort:true},*/
