...
<head>
    ...
    <script language="javascript">
        ...
        jQuery(function($) {
            ...
            $("#username").val(localStorage.getItem("newname"));
        ...
        function userlogin() {
            ...
            $.ajax({
                ...
                success : function(data) {
                    if (data.code == 0) {
                        localStorage.setItem('newname',data.newname);
                        localStorage.setItem('token',data.token);
                        parent.location.href = 'view/index.jsp';
                    } else{
                        alert(data.msg);
                    }
                },
...
<div>
    ...
    <div class="box">
        ...
        <div style="margin-top: 30px;">
            <div  class="div_img"><img src="<%=basePath%>images/login/user.png" class="user_img"/></div>
            <div style="float:left" >  <input type="text" id="username" name="username"   class="user_input"/></div>
            <div style="clear: both;"></div>
        </div>
        <div style="margin-top: 18px;">
            <div   class="div_img"><img src="<%=basePath%>images/login/psd.png" class="user_img"/></div>
