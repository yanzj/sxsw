...
<script type="text/javascript" src="<%=basePath%>bussiness/aviation/ptgl/pzkgl/databaseinfo.js"></script>
</head>
<body>
	<div id="toolbar" class="searchDiv">
		<form id="serchform" method="post">
			<table>
				<tr>
					<td align="center" class="ser_cont">库名称:</td>
					<td class="ser_tit"><input type="text" id="MC" value="" />
					</td>
