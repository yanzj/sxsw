...
<script type="text/javascript" src="<%=basePath%>bussiness/aviation/ptgl/djgl/level.js"></script>
</head>
<body>
	<div id="toolbar" class="searchDiv">
		<form id="serchform" method="post">
			<table>
				<tr>
					<td align="center" class="ser_cont">等级名称:</td>
					<td class="ser_tit"><input type="text" id="DJMC" value="" />
					</td>
					<td align="center" class="ser_cont">&nbsp;&nbsp;等级简称:</td>
					<td class="ser_tit"><input type="text" id="DJJC" value="" />
					</td>
