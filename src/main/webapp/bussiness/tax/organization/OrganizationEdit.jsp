...
<head>
    ...
    <script type="text/javascript">
        	...
        	form = $("#form2").ligerForm({
                ...
                fields: [ 
                	{ name: "AREA", type: "hidden"},
               	    { label: "名称", name: "TYPENAME", newline: true, width:300,type:"text",validate: { required: true}},
		...
		function datePost(){
			...
			var data = {"TYPENAME":TYPENAME,"MEMO":MEMO,"organization.ID":<%=id %>,"AREA":AREA};
			return data;
		}
		
	function getCodeInfo(){
		  $.ajax({
			url:"OrganizationQueryById.action?id=<%=id %>", 
			async:false,
			dataType:"json", 
			type:"post",
			success:function (mm) {
