    ...
    <script type="text/javascript">
        ...
        $(function (){
        	form = $("#form2").ligerForm({
                ...
                fields: [ 
                    ...
                    { label: "人社单位登记类型",name: "COMPANY_TYPE", newline: false, type: "text", width:280 },
                    ...
                    { label: "社保区域", name: "AREANAME", newline: false, type: "text", width:280}, 
                    { label: "社保类型", name: "TYPENAME", newline: false, type: "text", width:280},   
                 /* { label: "人社单位电话",name: "COMPANY_TEL", newline: false, type: "text", width:280},
                    ...
                    { label: "密码",name: "PASSWORD", newline: false, type: "text", type: "text", width:280 }, 
                    { label: "修改", name: "IF_MODIFY", newline: false, type: "text", width:280},                    
                    { label: "匹配", name: "IF_MATCHED", newline: false, type: "text", width:280},  */                   
                                 
                    { label: "审核", name: "type", newline: true, type: "select", width:280, validate: { required: true }, dictionary: '通过|驳回',
                    	editor: {
                     ...
                     { label: "备注", name: "MEMO", newline: true, width:727,type:"textarea", validate: { maxlength: 200 }}  
		...
		function datePost(){
		 var  formData= liger.get("form2").getData();		 
			...
			var REMARK = formData.MEMO;
			var data = {"TYPE":TYPE,"REMARK":REMARK};
			return data;
		}
		 ...
		 function  getMess(mid){
			...
			success:function (mm) {
			   ...
			   form.setEnabled(["REGISTERED_RESIDENCE"], false); 
			    form.setEnabled(["TYPENAME"], false); 
			   form.setEnabled(["AREANAME"], false); 
			   var a;
			    if(0==mm.IF_MODIFY){
			        a='未修改';
			        }else{
